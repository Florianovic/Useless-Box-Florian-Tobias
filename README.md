...
Als Erstes wird mit dem Befehl <br>![CodeUB (2)](https://github.com/Florianovic/Useless-Box-Florian-Tobias/blob/master/CodeUB%20(2).PNG)<br> die Datenbank angesteuert, welche benötigt wird um die Servomotoren anzusteuern.
